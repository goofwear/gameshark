# GameShark Compatibility v0.7.3
...
Copy the `gen1recomp_gameshark_v0.7.3_universal` folder into the Gen1Recomp `mods` folder, restart the game, enable **GameShark Compatibility**, then open **START -> GAMESHARK**.
...
## v0.7.3 — Gold Wild Pick customization
...
## v0.7.3 — Gen1Recomp 0.1.93 compatibility
...
When **STEAL TRAINER** is enabled, v0.7.3 now:
...
Starting with the clean-ID v0.7.3 package, the manifest ID and installed folder
are both:
...
## v0.7.3 — Red / Blue / Yellow trainer-capture fix
...
## v0.7.3 — Wild Pokémon setup redesign
...
## v0.7.3 — Instant Battle + Wild menu spacing
...
## v0.7.3 — Gold Instant Battle fix
...
v0.7.3 selects the proper supported Gen1Recomp API at runtime:
...
## v0.7.3 — Teleport UI + DV/EV stat refresh fixes
...
## v0.7.3 — Teleport menu-stack fix
...
## v0.7.3 — Gen 1 Teleport regression fix + stat preview
...
v0.7.3 now uses generation-specific behavior:
